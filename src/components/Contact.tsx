        ...
        <div className='grid md:grid-cols-2 gap-10'>
            ...
            <div className='space-y-8'>
                ...
                <div className='flex flex-col gap-1' data-aos="zoom-in-up">
                    ...
                    <textarea
                      className='bg-transparent border border-pink-600 border-t rounded-md min-h-[100px]'
                      id='message'
                      rows={8}
                    ></textarea>
                </div>
                <button className="bg-pink-800 p-2 px-6 text-white text-xl font-bold block" data-aos="zoom-in-up">
                  Send
                </button>
            </div>
        </div>
